...
"""
OK working. Now just need to make all the text green and I think the basic version is finished.
"""
# import pygame
# import sys
# import math
...
#         ]
#         for i, line in enumerate(help_lines):
#             screen.blit(font_small.render(line, True, DIM_GREEN), (ui_x, HEIGHT - 240 + i * 20))
...
"""
Close just needs to close some gaps
"""
# import pygame
# import sys
# import math
...
#         draw_corridor(screen, 685, 300, 580, 300)
...
#             'B4: Bridge to Engineering',
#             'B5/B6: Mid corridors',
#             'B7: Hypersleep to Reactor',
#             'Seal B8, B9, B10 for cargo',
#             'Then open airlock'
#         ]
#         for i, line in enumerate(help_lines):
#             screen.blit(font_small.render(line, True, DIM_GREEN), (ui_x, HEIGHT - 240 + i * 20))
...
"""
Attempt to try and add more corridors etc. to the game to increase complexity

It looks great except no proper visual connection between B7 and Reactor; attempting to fix. 
"""
# import pygame
# import sys
# import math
...
#     waypoint_bridge_to_eng = PathNode(110, 240, 'waypoint')
#     waypoint_hypersleep_to_reactor = PathNode(685, 250, 'waypoint')
...
#         draw_corridor(screen, 490, 140, 490, 270)
#         draw_corridor(screen, 110, 140, 110, 250)
#         draw_corridor(screen, 685, 140, 685, 260)
#         draw_corridor(screen, 240, 300, 320, 300)
#         draw_corridor(screen, 440, 300, 520, 300)
#         draw_corridor(screen, 160, 360, 160, 440)
#         draw_corridor(screen, 380, 340, 380, 440)
...
"""
Looks great, going to try for more visual improvements
"""
# import pygame
# import sys
# import math
...
#         # More aggressive radar ring effect
#         if (pygame.time.get_ticks() // 250) % 2 == 0:
#             pygame.draw.circle(surface, color, (int(self.x), int(self.y)), int(pulse + 6), 1)
#         if self.state == 'moving' and (pygame.time.get_ticks() // 150) % 2 == 0:
#             pygame.draw.circle(surface, color, (int(self.x), int(self.y)), int(pulse + 10), 1)
...
"""
WORKING CODE FOR THE BASIC GAME
"""
# import pygame
# import sys
# import math
